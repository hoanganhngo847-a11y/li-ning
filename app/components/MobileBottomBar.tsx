...
export default function MobileBottomBar() {
  ...
  return (
    <>
      <div className="h-16 md:hidden"></div> {/* Spacer so content isn't hidden behind fixed bar */}
      <div className="fixed bottom-0 left-0 w-full bg-white border-t border-gray-200 z-40 flex justify-around items-center h-16 px-2 md:hidden shadow-[0_-2px_10px_rgba(0,0,0,0.05)]">
          ...
          return (
            <Link 
              ...
              className={cn(
                ...
                isActive ? "text-[#f30d29]" : "text-gray-500 hover:text-[#f30d29]"
              )}
            >
              {item.icon}
